...
import { SelectCouponComponent } from '../Coupon/Components/select-coupon/select-coupon.component';
...
import { ICouponRespone } from '../Coupon/Core/Interfaces/icoupon-respone';
import { Router, RouterModule } from '@angular/router';
import { ListCouponService } from '../Coupon/Core/Service/list-coupon.service';
...
import { TableCoupanComponent } from '../Coupon/Components/table-coupan/table-coupan.component';

@Component({
  selector: 'app-quizlist',
  standalone: true,
    imports: [SelectCouponComponent, WidgetquizlistComponent, CommonModule, RouterModule, ButtonModule,TranslateModule, FormsModule, DatePicker, TabsModule, MatTooltipModule, TableCoupanComponent],
