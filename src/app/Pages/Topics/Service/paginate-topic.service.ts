...
export class PaginateTopicService {
  ...
  constructor(private _HttpClient :HttpClient) {
   ...
   getTopics(orderBy: number = 2, pageNumber: number = 1, pageSize: number = 500, orderBeforPagination: boolean = false, orderDirection: number = 1): Observable<IPaginationResponse<TopicResult>> {
